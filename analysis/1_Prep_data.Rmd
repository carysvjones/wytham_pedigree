...
#just have input data 1960-2021
...
#quick summaries
nrow(breed_gtit) #15307
length(unique(breed_gtit$Pnum)) #15307
length(unique(breed_gtit$Mother)) #7345
summary(breed_gtit$Mother) #2853 mothers unknown  
length(unique(breed_gtit$Father)) #6039
summary(breed_gtit$Father) #5442
...
unique(subset(breed_gtit, !is.na(Experiment.codes))$year)
...
nrow(subset(breed_gtit_noNA, is.na(Mother))) #3226

nrow(subset(breed_gtit_noNA, is.na(Father))) #5704

#have both parents
nrow(subset(breed_gtit_noNA, !is.na(Mother) & !is.na(Father))) #9117
#have just mother
nrow(subset(breed_gtit_noNA, !is.na(Mother))) #11966
nrow(subset(breed_gtit_noNA, !is.na(Mother) & is.na(Father))) #2849 have no mother but have father

#have jsut father
nrow(subset(breed_gtit_noNA, !is.na(Father))) #9488
nrow(subset(breed_gtit_noNA, !is.na(Father) & is.na(Mother))) #371 have no father but have mother
